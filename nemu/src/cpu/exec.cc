...
/* 0x80 */	op_group({&add<op_rm_b, op_imm_b>, &or_<op_rm_b, op_imm_b>, &adc<op_rm_b, op_imm_b>, inv, &and_<op_rm_b, op_imm_b>, &sub<op_rm_b, op_imm_b>, &xor_<op_rm_b, op_imm_b>, &cmp<op_rm_b, op_imm_b>}),
/* 0x81 */  op_group({&add<op_rm_v, op_imm_v>, &or_<op_rm_v, op_imm_v>, &adc<op_rm_v, op_imm_v>, inv, &and_<op_rm_v, op_imm_v>, &sub<op_rm_v, op_imm_v>, &xor_<op_rm_v, op_imm_v>, &cmp<op_rm_v, op_imm_v>}),
/* 0x82 */  inv,
/* 0x83 */  op_group({&add<op_rm_v, op_imm_b>, &or_<op_rm_v, op_imm_b>, &adc<op_rm_v, op_imm_b>, inv, &and_<op_rm_v, op_imm_b>, &sub<op_rm_v, op_imm_b>, &xor_<op_rm_v, op_imm_b>, &cmp<op_rm_v, op_imm_b>}),
...
/* 0xf4 */	inv, inv,
/* 0xf6 */  op_group({&test<op_rm_b, op_imm_b>, inv, inv, &neg<op_rm_b>, &mul<op_rm_b>, &imul<op_rm_b>, &div<op_rm_b>, &idiv<op_rm_b>}),
/* 0xf7 */  op_group({&test<op_rm_v, op_imm_v>, inv, inv, &neg<op_rm_v>, &mul<op_rm_v>, &imul<op_rm_v>, &div<op_rm_v>, &idiv<op_rm_v>}),
...
/* 0x90 */	&seto<op_imm_v>, &setno<op_imm_v>, &setb<op_imm_v>, &setae<op_imm_v>,
/* 0x94 */	&sete<op_imm_v>, &setne<op_imm_v>, &setbe<op_imm_v>, &seta<op_imm_v>,
/* 0x98 */	&sets<op_imm_v>, &setns<op_imm_v>, &setp<op_imm_v>, &setnp<op_imm_v>,
/* 0x9c */	&setl<op_imm_v>, &setge<op_imm_v>, &setle<op_imm_v>, &setg<op_imm_v>,
