...
/* opcode with reg/op */
template <helper_fun ...fs> HELPER(op_group);
/* 2-byte opcode */
HELPER(op_escape);
/* instruction prefix */
...
/* 0xc0 */  &op_group<&rol<op_rm_b, op_imm_b>, &ror<op_rm_b, op_imm_b>, &rcl<op_rm_b, op_imm_b>, &rcr<op_rm_b, op_imm_b>, &shl<op_rm_b, op_imm_b>, &shr<op_rm_b, op_imm_b>, inv, &sar<op_rm_b, op_imm_b>>,
/* 0xc1 */  &op_group<&rol<op_rm_v, op_imm_b>, &ror<op_rm_v, op_imm_b>, &rcl<op_rm_v, op_imm_b>, &rcr<op_rm_v, op_imm_b>, &shl<op_rm_v, op_imm_b>, &shr<op_rm_v, op_imm_b>, inv, &sar<op_rm_v, op_imm_b>>,
...
/* 0xd0 */  &op_group<&rol<op_rm_b, op_1>, &ror<op_rm_b, op_1>, &rcl<op_rm_b, op_1>, &rcr<op_rm_b, op_1>, &shl<op_rm_b, op_1>, &shr<op_rm_b, op_1>, inv, &sar<op_rm_b, op_1>>,
/* 0xd1 */  &op_group<&rol<op_rm_v, op_1>, &ror<op_rm_v, op_1>, &rcl<op_rm_v, op_1>, &rcr<op_rm_v, op_1>, &shl<op_rm_v, op_1>, &shr<op_rm_v, op_1>, inv, &sar<op_rm_v, op_1>>,
/* 0xd2 */  &op_group<&rol<op_rm_b, op_c_b>, &ror<op_rm_b, op_c_b>, &rcl<op_rm_b, op_c_b>, &rcr<op_rm_b, op_c_b>, &shl<op_rm_b, op_c_b>, &shr<op_rm_b, op_c_b>, inv, &sar<op_rm_b, op_c_b>>,
/* 0xd3 */  &op_group<&rol<op_rm_v, op_c_b>, &ror<op_rm_v, op_c_b>, &rcl<op_rm_v, op_c_b>, &rcr<op_rm_v, op_c_b>, &shl<op_rm_v, op_c_b>, &shr<op_rm_v, op_c_b>, inv, &sar<op_rm_v, op_c_b>>,
...
/* 0xa0 */  inv, inv, inv, &bt<op_rm_v, op_reg_v>,
...
/* 0xb8 */  inv, inv, &op_group<inv, inv, inv, inv, &bt<op_rm_v, op_imm_b>, inv, inv, inv>, inv,
...
template <helper_fun ...fs>
HELPER(op_group) {
    static helper_fun func[] = {fs...};
    ModR_M modrm;
    modrm.value = instr_fetch(eip + 1, 1);
    ctx.require_modrm = true;
    return func[modrm.regop](ctx, eip);
}
