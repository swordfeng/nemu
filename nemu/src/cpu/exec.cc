...
/* 0x80 */	op_group({inv, inv, inv, inv, inv, &sub<op_rm_b, op_imm_b>, inv, &cmp<op_rm_b, op_imm_b>}),
/* 0x81 */  op_group({inv, inv, inv, inv, inv, &sub<op_rm_v, op_imm_v>, inv, &cmp<op_rm_v, op_imm_v>}),
/* 0x82 */  inv,
/* 0x83 */  op_group({inv, inv, inv, inv, inv, &sub<op_rm_v, op_imm_b>, inv, &cmp<op_rm_v, op_imm_b>}),
